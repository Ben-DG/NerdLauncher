...
public class NerdLauncherFragment extends Fragment {
    ...
    private class ActivityHolder extends RecyclerView.ViewHolder
        ...
        public ActivityHolder(LayoutInflater inflater, ViewGroup parent) {
            ...
            mNameTextView = (TextView) itemView.findViewById(R.id.activity_text_view);
            mNameImageView = (ImageView) itemView.findViewById(R.id.activity_image_view);
        ...
        public void bindActivity(ResolveInfo resolveInfo) {
            ...
            mNameImageView.setImageDrawable(appIcon);
        }
